...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: QDHkXdk0MW-/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: rtVXJJFPDt8/css
            ...
            >
              {p.renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
                    <Select__Option
                      className={classNames("__wab_instance", sty.option__wnTA)}
    ...
    props = {
      ...
      children: (
        <React.Fragment>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option__d4AhL)}
            value={"value2" as const}
          >
            {"Option 2"}
          </Select__Option>
