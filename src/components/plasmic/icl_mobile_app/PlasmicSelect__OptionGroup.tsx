...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: QbtrxRcZyNA/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: rtVXJJFPDt8/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__vmYcm)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__cUpVp)}
              />
            </React.Fragment>
          ),
          value: args.children
